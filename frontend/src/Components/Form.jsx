...
import {Box,Input,Stack,Image,Heading,Text, FormControl, FormLabel, Select, Tag, Button} from "@chakra-ui/react";

const TagsArr=["1-20","21-50","51-200","201-500","500+"]
  ...
  return (
    ...
    <Box position="absolute" top="75px" left="31%" zIndex={100}  w="40%" bgColor={"white"} p="40px" borderRadius={"10px"}  boxShadow="rgba(149, 157, 165, 0.2) 0px 8px 24px;" >
      <Stack gap="15px" w="70%" m="auto">
        <Image display={"block"} m="auto" w="40px" h="35px" src='https://i.ibb.co/kXSrMcQ/logo.png' />
      ...
      <FormControl>
       ...
       <option>Bollywood Industries</option>
       </Select>
      </FormControl>
      </Stack>
